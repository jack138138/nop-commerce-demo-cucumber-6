...
//    WebElement totalCommander;
    ...
    public void selectProcessorFromDropDown(String processor) {
        log.info("Select Processor From DropDowm:" + processor + "select from dropdown" + processorDropDown.toString());
        selectByVisibleTextFromDropDown(processorDropDown, processor);
    }

    public void selectRamFromDropDown(String ram) {
        log.info("Select RAM from DropDown list:" + ram + "from dropdown"+  ramDropDown.toString()) ;
        selectByVisibleTextFromDropDown(ramDropDown, ram);
    }

    public void selectHDDRadios(String hddRadio) {
        log.info("Select HDD from DropDown list:" + hddRadio + "from dropdown" + hdd320GB.toString() + hdd400GB.toString());
    ...
    public void selectOSRadioButton(String osRadio) {
        log.info("Select OSRadio Button:" + osRadio+ "from list" + vistaHome.toString());
    ...
    public void selectSoftwareType(String software) {
        log.info("Select Software Type:" + software + "select" + softwareSelection.toString());
